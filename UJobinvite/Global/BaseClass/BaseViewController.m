...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [ColorManager sharedInstance].view_bgColor;
...
- (void)setNavbarParam{
    ...
    self.navigationController.navigationBar.tintColor = [ColorManager sharedInstance].navTitleColor;
    self.navigationController.navigationBar.barTintColor = [ColorManager sharedInstance].navTitleColor;
}

- (void)setNaviTitle:(NSString *)naviTitle{
    //[self setNaviTitle:naviTitle textColor:RGB_COLOR_String(@"#1D1D27")];//灰黑
    [self setNaviTitle:naviTitle textColor:[ColorManager sharedInstance].navTitleColor];
}
